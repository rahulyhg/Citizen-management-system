...
?>
	<section class="side-menu fixed left">
		<div class="top-sec">
			...
			<p>Citizen Record System</p>
		</div>
		<ul class="nav">
			<li class="nav-item current"><a href="../dashboard"><span class="nav-icon"><i class="fa fa-users"></i></span>All Citizen</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">All Citizen</div>
				<div class="top-bar">
					<div class="top-item">
				...
				<ul class="emp_list">
					<li class="emp_list_head">
						<div class="emp_item_head emp_id">Citizen ID</div>
