...
?>
	<section class="side-menu fixed left">
		<div class="top-sec">
			...
			<p>Citizen management System</p>
		</div>
		<ul class="nav">
			<li class="nav-item"><a href="../dashboard"><span class="nav-icon"><i class="fa fa-users"></i></span>All Citizen</a></li>
			<li class="nav-item"><a href="../dashboard/current_employees.php"><span class="nav-icon"><i class="fa fa-check"></i></span>Current Citizen</a></li>
			<li class="nav-item"><a href="../dashboard/past_employees.php"><span class="nav-icon"><i class="fa fa-times"></i></span>Past Citizen</a></li>
			<?php if($usertype == "Admin"){ ?>
				<li class="nav-item current"><a href="../dashboard/add_employee.php"><span class="nav-icon"><i class="fa fa-user-plus"></i></span>Add Citizen</a></li>
	...
	<section class="contentSection right clearfix">
		...
		<div class="container">
			<div class="wrapper add_employee clearfix">
				<div class="section_title">Add Citizen</div>
				<form id="addemployee" class="clearfix" method="" action="">
					...
					<div class="input-box input-small left">
						<label for="employee_id">Adhar number</label><br>
					...
					<div class="section_subtitle left">Upload Citizen Photo</div>
					<div class="input-box input-upload-box left">
						<div class="upload-wrapper">
							<div class="upload-box">
								<input type="file" name="passport_photo" class="uploadField passport_photo">
								<div class="uploadfile passportPhoto_file">Upload Citizen Photo</div>
					...
					<div class="section_subtitle left">Upload Id</div>
					<div class="input-box input-small left">
