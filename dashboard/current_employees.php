...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<li class="nav-item current"><a href="../dashboard/current_employees.php"><span class="nav-icon"><i class="fa fa-check"></i></span>Current Citizen</a></li>
			...
			<?php if($usertype == "Admin"){ ?>
				<li class="nav-item"><a href="../dashboard/add_employee.php"><span class="nav-icon"><i class="fa fa-user-plus"></i></span>Add Citizen</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">All Current Citizen</div>
				<div class="top-bar">
					<div class="top-item">
				...
				<ul class="emp_list">
					<li class="emp_list_head">
						<div class="emp_item_head emp_id">Adhar Number</div>
