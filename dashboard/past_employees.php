...
?>
	<section class="side-menu fixed left">
		...
		<ul class="nav">
			...
			<li class="nav-item current"><a href="../dashboard/past_employees.php"><span class="nav-icon"><i class="fa fa-times"></i></span>Past Citizen</a></li>
	...
	<section class="contentSection right clearfix">
		<div class="container">
			<div class="wrapper employee_list clearfix">
				<div class="section_title">All Past /div>
				<div class="top-bar">
					<div class="top-item">
